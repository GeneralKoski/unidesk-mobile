...
const actionsheetContentStyle = tva({
  base: "items-center rounded-tl-3xl rounded-tr-3xl px-0 pt-4 pb-8 bg-background-0 web:pointer-events-auto web:select-none shadow-lg",
});
...
const actionsheetDragIndicatorWrapperStyle = tva({
  base: "w-full pt-1 pb-3 items-center",
});
